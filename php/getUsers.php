<?php
        ...
        if ($link) {
          ...
          if ($isLoggedIn) {
                $sql = "SELECT id as Id,isadmin as IsAdmin,firstname as FirstName,lastname as LastName,phone as Phone,email as Email,active as Active
						FROM users WHERE default_admin = '0'";
